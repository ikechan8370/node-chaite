import M from"./MessageContentCard-333YPcPx.js";import{b5 as H,a6 as K,bM as L,a7 as i,ay as g,ax as f,ak as s,d as w,aa as B,ad as P,p as m,aN as q,aV as U,q as S,aE as $,aP as G,bk as J,s as C,am as v,bc as Q,ag as X,b as x,o as u,w as z,e as b,u as p,bo as Y,c as T,I as Z,F as ee,A as te,n as ie,K as ne,bp as oe}from"./index-03UGSOxl.js";import{N as re}from"./Spin-yYcNW-yl.js";let _=!1;function le(){if(H&&window.CSS&&!_&&(_=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function se(e){const{textColor3:n,infoColor:o,errorColor:l,successColor:t,warningColor:a,textColor1:r,textColor2:d,railColor:c,fontWeightStrong:h,fontSize:y}=e;return Object.assign(Object.assign({},L),{contentFontSize:y,titleFontWeight:h,circleBorder:`2px solid ${n}`,circleBorderInfo:`2px solid ${o}`,circleBorderError:`2px solid ${l}`,circleBorderSuccess:`2px solid ${t}`,circleBorderWarning:`2px solid ${a}`,iconColor:n,iconColorInfo:o,iconColorError:l,iconColorSuccess:t,iconColorWarning:a,titleTextColor:r,contentTextColor:d,metaTextColor:n,lineColor:c})}const ae={common:K,self:se},k=1.25,ce=i("timeline",`
 position: relative;
 width: 100%;
 display: flex;
